...
For mobile fixes, check the affected width and one adjacent device class when possible. Do not run broad browser scenario suites by default. Load safe-edit-verify for targeted rendered verification and protect desktop, tablet, mobile, and PWA behavior.
