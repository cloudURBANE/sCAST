...
Load dev-commands and verify-without-regression for repository-specific commands. Skip repetitive browser/device scenarios unless the changed behavior specifically requires them. Never claim full verification from a partial check.
