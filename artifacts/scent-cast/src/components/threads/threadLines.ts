...
export const THREAD_LINES: ThreadLine[] = [
  {
    ...
    boxShadow: '0 0 30px rgba(0, 0, 0, 0.5), 0 0 60px rgba(0, 0, 0, 0.3)',    axis: 'x', direction: 1, speed: 2.8, wrap: 100, fade: 50,
  },
  {
    id: 'dark-2',
    ...
    boxShadow: '0 0 25px rgba(0, 0, 0, 0.4), 0 0 50px rgba(0, 0, 0, 0.2)',    axis: 'x', direction: -1, speed: 2, wrap: 80, fade: 50,
  },
  {
    id: 'gold-1',
    ...
    boxShadow: '0 0 16px rgba(255, 247, 236, 0.42), 0 0 34px rgba(212, 175, 55, 0.62), 0 0 74px rgba(251, 191, 36, 0.24)',    axis: 'x', direction: 1, speed: 2.55, wrap: 132, fade: 64,
  },
  {
    id: 'dark-v-1',
    ...
    boxShadow: '0 0 20px rgba(0, 0, 0, 0.4), 0 0 40px rgba(0, 0, 0, 0.2)',    axis: 'y', direction: 1, speed: 1.5, wrap: 85, fade: 40,
  },
  {
    id: 'gold-v-1',
    ...
    boxShadow: '0 0 20px rgba(251, 191, 36, 0.4), 0 0 46px rgba(212, 175, 55, 0.24)',    axis: 'y', direction: -1, speed: 1.35, wrap: 96, fade: 52,
  },
  {
    id: 'dark-3',
  ...
  },
  {
    ...
    boxShadow: '0 0 18px rgba(0, 0, 0, 0.38), 0 0 34px rgba(0, 0, 0, 0.14)',    axis: 'x', direction: 1, speed: 2.85, wrap: 118, fade: null,
  },
  {
    id: 'white-1',
    ...
    boxShadow: '0 0 18px rgba(255, 255, 255, 0.4), 0 0 35px rgba(255, 255, 255, 0.2)',    axis: 'x', direction: 1, speed: 1.6, wrap: 75, fade: null,
  },
  {
    id: 'dark-5',
  ...
  },
  {
    ...
    boxShadow: '0 0 16px rgba(0, 0, 0, 0.3), 0 0 32px rgba(0, 0, 0, 0.1)',    axis: 'x', direction: 1, speed: 2.1, wrap: 65, fade: null,
  },
  {
    id: 'gold-2',
    ...
    boxShadow: '0 0 16px rgba(212, 175, 55, 0.4), 0 0 32px rgba(251, 191, 36, 0.22)',    axis: 'x', direction: 1, speed: 1.6, wrap: 55, fade: null,
  },
  {
    id: 'dark-7',
  ...
  },
  {
    ...
    boxShadow: '0 0 18px rgba(212, 175, 55, 0.4), 0 0 36px rgba(251, 191, 36, 0.18)',    axis: 'x', direction: 1, speed: 1.4, wrap: 70, fade: null,
  },
  {
    id: 'gold-v-2',
    ...
    boxShadow: '0 0 15px rgba(251, 191, 36, 0.38), 0 0 30px rgba(212, 175, 55, 0.22)',    axis: 'y', direction: 1, speed: 1.2, wrap: 60, fade: null,
  },
  {
    id: 'white-2',
    ...
    boxShadow: '0 0 18px rgba(255, 255, 255, 0.38), 0 0 34px rgba(212, 175, 55, 0.18)',    axis: 'x', direction: 1, speed: 2.25, wrap: 88, fade: 48,
  },
  {
    id: 'white-v-1',
    ...
    boxShadow: '0 0 18px rgba(255, 255, 255, 0.5), 0 0 36px rgba(255, 255, 255, 0.2)',    axis: 'y', direction: 1, speed: 1.5, wrap: 65, fade: 35,
  },
  {
    id: 'white-3',
    ...
    boxShadow: '0 0 16px rgba(255, 255, 255, 0.5), 0 0 32px rgba(255, 255, 255, 0.2)',    axis: 'x', direction: -1, speed: 1.6, wrap: 70, fade: 40,
  },
  {
    id: 'white-4',
    ...
    boxShadow: '0 0 22px rgba(255, 255, 255, 0.6), 0 0 44px rgba(255, 255, 255, 0.3)',    axis: 'x', direction: 1, speed: 1.7, wrap: 80, fade: 45,
  },
  {
    id: 'white-v-2',
    bottom: '0px', right: '10%', width: '1.6px', height: '60px',
    background: 'linear-gradient(180deg, transparent 0%, rgba(255, 255, 255, 0.6) 25%, rgba(255, 255, 255, 0.8) 50%, rgba(255, 255, 255, 0.6) 75%, transparent 100%)',
    boxShadow: '0 0 18px rgba(255, 255, 255, 0.5), 0 0 36px rgba(255, 255, 255, 0.2)',    axis: 'y', direction: -1, speed: 1.4, wrap: 60, fade: 35,
  },
  {
    id: 'gold-v-3',
    ...
    boxShadow: '0 0 25px rgba(251, 191, 36, 0.28), 0 0 50px rgba(212, 175, 55, 0.12)',    axis: 'y', direction: 1, speed: 0.8, wrap: 85, fade: 45,
  },
  {
    id: 'gold-4',
    ...
    boxShadow: '0 0 28px rgba(212, 175, 55, 0.38), 0 0 56px rgba(251, 191, 36, 0.2)',    axis: 'x', direction: 1, speed: 1.1, wrap: 95, fade: 50,
  },
  {
    id: 'gold-5',
    ...
    boxShadow: '0 0 20px rgba(212, 175, 55, 0.3), 0 0 40px rgba(251, 191, 36, 0.12)',    axis: 'x', direction: -1, speed: 0.9, wrap: 75, fade: 40,
  },
];
