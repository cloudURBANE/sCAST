...
export const THREAD_LINES: ThreadLine[] = [
  ...
  },
  {
    ...
    background: 'linear-gradient(90deg, transparent 0%, rgba(30, 58, 138, 0.8) 25%, rgba(29, 78, 216, 0.9) 50%, rgba(37, 99, 235, 0.8) 75%, transparent 100%)',
    boxShadow: '0 0 30px rgba(30, 58, 138, 0.6), 0 0 60px rgba(29, 78, 216, 0.4)',
    filter: 'blur(0.3px)',
  ...
  },
  {
    ...
    background: 'linear-gradient(180deg, transparent 0%, rgba(59, 130, 246, 0.7) 20%, rgba(37, 99, 235, 0.8) 50%, rgba(30, 58, 138, 0.7) 80%, transparent 100%)',
    boxShadow: '0 0 25px rgba(59, 130, 246, 0.5), 0 0 50px rgba(37, 99, 235, 0.3)',
    filter: 'blur(0.3px)',
  ...
  },
  {
    ...
    background: 'linear-gradient(90deg, transparent 0%, rgba(37, 99, 235, 0.6) 30%, rgba(59, 130, 246, 0.8) 50%, rgba(30, 58, 138, 0.6) 70%, transparent 100%)',
    boxShadow: '0 0 16px rgba(37, 99, 235, 0.4), 0 0 32px rgba(59, 130, 246, 0.2)',
    filter: 'blur(0.3px)',
  ...
  },
  {
    ...
    background: 'linear-gradient(90deg, transparent 0%, rgba(30, 58, 138, 0.6) 25%, rgba(29, 78, 216, 0.8) 50%, rgba(30, 58, 138, 0.6) 75%, transparent 100%)',
    boxShadow: '0 0 18px rgba(30, 58, 138, 0.4), 0 0 36px rgba(29, 78, 216, 0.2)',
    filter: 'blur(0.2px)',
  ...
  },
  {
    ...
    background: 'linear-gradient(180deg, transparent 0%, rgba(59, 130, 246, 0.5) 25%, rgba(37, 99, 235, 0.7) 50%, rgba(59, 130, 246, 0.5) 75%, transparent 100%)',
    boxShadow: '0 0 15px rgba(59, 130, 246, 0.4), 0 0 30px rgba(37, 99, 235, 0.2)',
    filter: 'blur(0.2px)',
  ...
  },
  {
    ...
    background: 'linear-gradient(180deg, transparent 0%, rgba(59, 130, 246, 0.4) 20%, rgba(37, 99, 235, 0.6) 50%, rgba(30, 58, 138, 0.4) 80%, transparent 100%)',
    boxShadow: '0 0 25px rgba(59, 130, 246, 0.3), 0 0 50px rgba(37, 99, 235, 0.1)',
    filter: 'blur(0.3px)',
  ...
  },
  {
    ...
    background: 'linear-gradient(90deg, transparent 0%, rgba(37, 99, 235, 0.5) 25%, rgba(59, 130, 246, 0.7) 50%, rgba(30, 58, 138, 0.5) 75%, transparent 100%)',
    boxShadow: '0 0 28px rgba(37, 99, 235, 0.4), 0 0 56px rgba(59, 130, 246, 0.2)',
    filter: 'blur(0.3px)',
  ...
  },
  {
    ...
    background: 'linear-gradient(90deg, transparent 0%, rgba(30, 58, 138, 0.4) 30%, rgba(29, 78, 216, 0.6) 50%, rgba(37, 99, 235, 0.4) 70%, transparent 100%)',
    boxShadow: '0 0 20px rgba(30, 58, 138, 0.3), 0 0 40px rgba(29, 78, 216, 0.1)',
    filter: 'blur(0.2px)',
