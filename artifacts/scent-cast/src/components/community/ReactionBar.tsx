      ...
      {REACTIONS.map(({ key, label, Icon }) => {
        ...
        return (
          ...
          >
            ...
            <span className="font-mono text-[13px] text-scent-accent">{count}</span>
          </button>
        );
      })}
    </div>
