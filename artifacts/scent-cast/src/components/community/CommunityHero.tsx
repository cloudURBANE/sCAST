...
export const CommunityHero: React.FC = () => (
  <section className="scent-hero-zone mx-auto w-full max-w-[940px] overflow-hidden rounded-[calc(var(--radius-scent)-2px)] border border-scent-accent/55 bg-[#050403] px-4 py-3.5 text-center sm:rounded-[calc(var(--radius-scent)+6px)] sm:px-10 sm:py-7 lg:px-16 lg:py-8">
