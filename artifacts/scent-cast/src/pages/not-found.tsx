...
export default function NotFound() {
  return (
    <main className="relative z-10 flex min-h-[100svh] w-full items-center justify-center px-6 py-20 text-white">
      <section className="mx-auto flex w-full max-w-2xl flex-col items-center text-center">
        <img
          ...
          draggable={false}
        />
        <div className="mt-12 flex h-16 w-16 items-center justify-center rounded-full border border-scent-accent/25 bg-black/35 text-scent-accent shadow-[0_0_42px_rgba(212,175,55,0.14)]">
          <Compass size={28} aria-hidden="true" />
        </div>
        <p className="mt-8 text-[10px] font-bold uppercase tracking-[0.42em] text-scent-accent/80">404</p>
        <h1 className="mt-4 font-serif text-4xl italic leading-tight text-[#fff7ec] sm:text-6xl">
          This trail has gone cold.
        </h1>
        <p className="mt-5 max-w-md text-sm leading-7 text-scent-muted sm:text-base">
        ...
        <div className="mt-10 flex w-full max-w-sm flex-col gap-3 sm:flex-row sm:justify-center">
          ...
          <Link
            to="/community"
            className="inline-flex min-h-12 items-center justify-center rounded-[var(--radius-scent)] border border-white/12 px-6 text-[10px] font-bold uppercase tracking-[0.28em] text-[#f4debd]/85 transition-colors hover:border-scent-accent/45 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-scent-accent/45"
          >
            Community
          </Link>
        </div>
