...
const TOOL_LABELS: Record<string, string> = {
  ...
  beam_analyze_collection: 'Mapping the shape of your collection…',
  beam_score_candidates: 'Scoring your vault against tonight…',
  beam_compare_overlap: 'Seeing what already lives in your vault…',
  beam_find_similar: 'Tracing scents in the same family…',
  beam_discover_external: 'Scouting beyond the catalog…',
  beam_check_enrichment_state: 'Confirming the details are current…',
